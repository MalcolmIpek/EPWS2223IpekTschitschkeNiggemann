...
public class DragAndDrop : MonoBehaviour, IPointerDownHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IDropHandler
{
    ...
    public void OnBeginDrag(PointerEventData eventData)
    {
        ...
        /*if (eventData.pointerDrag.GetComponent<NewCircuitComponent>().socket != null)
        {
            eventData.pointerDrag.GetComponent<NewCircuitComponent>().RemoveFromSocket();
        }*/
    }
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        {
            case "Inventory":
                if (!gameObject.GetComponent<NewCircuitComponent>().isInInventory)
                {
                    InventoryManager.Instance.Add(gameObject.GetComponent<NewCircuitComponent>().item);
                    gameObject.GetComponent<NewCircuitComponent>().isInInventory = true;
                }
            ...
            case "CircuitPuzzle":
                if (gameObject.GetComponent<NewCircuitComponent>().isInInventory)
                {
                    gameObject.GetComponent<NewCircuitComponent>().isInInventory = false;
                    InventoryManager.Instance.Remove(gameObject.GetComponent<NewCircuitComponent>().item);
